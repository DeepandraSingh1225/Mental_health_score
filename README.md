...
> ⚠️ **Disclaimer:** This project predicts a **score**, not a medical diagnosis. See the [Disclaimer](#-disclaimer) section for details.
...
| Component | Link |
|---|---|
| 🌐 **Frontend** | [mental-health-score-frontend-okec.onrender.com](https://mental-health-score-frontend-okec.onrender.com) |
| ⚙️ **Backend (API)** | [mental-health-score-backend-h9nz.onrender.com](https://mental-health-score-backend-h9nz.onrender.com) |
